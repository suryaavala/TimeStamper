...
public class MyRecyclerViewAdapterCategory_old {
/*
    public List<Category> mCategoryList;
    MainActivity mainActivity;
    public int selectedPos = 0;

    public MyRecyclerViewAdapterCategory_old(List<Category> categoryList, MainActivity mainActivity) {
    ...
    @Override
    public MyRecyclerViewAdapterCategory_old.MyViewHolderCategory onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(MyRecyclerViewAdapterCategory_old.MyViewHolderCategory holder, int position) {
